...
$description = ask('Package description', "A {$className} app for Strata");
...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, 'database/migrations/create_skeleton_table.php.stub') => rename($file, './database/migrations/' . now()->format('Y_m_d') . '_100000_create_' . $packageSlugWithoutPrefix . '_table.php.stub'),
        str_contains($file, 'database/migrations/settings/2021_09_30_100000_create_skeleton_settings.php') => rename($file, './database/migrations/settings/' . now()->format('Y_m_d') . '_100000_create_' . $packageSlugWithoutPrefix . '_settings.php'),
